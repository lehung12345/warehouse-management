...
//       const inventoryRes = await axios.get(`${baseURL}/api/inventories`, getAuthHeader())
//       const inventoryData = Array.isArray(inventoryRes.data?.data) ? inventoryRes.data.data : []
//       const totalStock = inventoryData.reduce((sum: number, item: any) => sum + (item.quantity || 0), 0)
